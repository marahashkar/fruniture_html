...
$r1=mysqli_query($con,"select * from product where id='$x1'");
...
<div class="container">
            <h1 class="text-center text-info">Prduct Rating System   </h1>
...
<form action="rs.php?id=<?php echo $x1; ?>" method="post">
 ...
 <h1 class="text-center text-info">rate Product : <?php echo $dd['name']; ?> </h1>
        <hr>
    <div class="rateyo"
        ...
        ></div>
         ...
         <a href="../user.php" style="margin-left: 200px;">go back</a>
</div> 
</form>
...
if(isset($_POST['rate']))
{
$t=mysqli_query($con,"select * from ratepro where uname='$myname' and pname='$pname'");
if(mysqli_num_rows($t)>0)
{
echo'<script> alert("project rate is allready taken");</script>';
}
else{
       $z=mysqli_query($con,"insert into ratepro(uname,pname,rate)values
    ('$myname','$pname','$x')");
