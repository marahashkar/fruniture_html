...
">
<form action="signin.php" method="post"  style="border:1px solid #ccc; width: 75% padding: 20px; text-align: center;" >
  <div class="container">
    <h1>Sign Up</h1>
...
$newpass=md5($w);
  if (isset($_POST['signup'])) {
   ...
   $rr=mysqli_query($con,"insert into users(name,phone,email,pass,type) values('$x','$y','$z','$newpass',1)") ;
   if (isset($rr)) 
   {
