...
include'conn.php';
  ...
  if(isset($_GET['id']))
   $x=$_GET['id'];
 $result=mysqli_query($con,"select * from category where id='$x' ");
 ...
 $res= mysqli_query($con,"update category set name='$name',
   image='$imgname' where id='$x' ");
 if(isset($res)){
...
<form action="editcategory.php?id=<?php echo $x; ?>" method="post"  style="border:1px solid #ccc; width: 75% padding: 20px; text-align: center;" enctype="multipart/form-data"  >
