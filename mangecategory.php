...
<div class="container  " style="width: 90%">
  ...
  <table class="table table-striped table-bordered">
    ...
    while($row=mysqli_fetch_array($r))
    {
      ...
      <td> <a href="mangecategory.php?m='.$row['id'].'" class="btn btn-info btn-s "> 
      <i class="glyphicon glyphicon-trash "></i> </a> </td> 


      <td> <a href="editcategory.php? id='.$row['id'].'" class="btn btn-info btn-s"> 
   ...
   if (isset($_GET['m'])) {
   $x=$_GET['m'];
   mysqli_query($con,"delete from category where id='$x'");
